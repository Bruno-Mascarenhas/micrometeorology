...
CLIMATOLOGY_VARIABLES: tuple[VariableSpec, ...] = (
    ...
    VariableSpec(
        ...
        caveats=(
            ...
            "Mesma densidade induzida da onda curta incidente, com todas as escalas multiplicadas pelo albedo médio da era ({{param:gain:4}}, razão de energias com o denominador acima de 50 W/m²). Um único escalar é estimado; lambda e Kt_máx seguem herdados.",
